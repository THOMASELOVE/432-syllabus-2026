...
The [Course Calendar](https://thomaselove.github.io/432-2026/calendar.html) provides deadlines for all Labs, and instructions for each Lab are available on [our main website](https://thomaselove.github.io/432-2026/). Late work is penalized (see information at the top of each Lab.) **All students must complete all 7 labs in order to pass the course.**
